return {
	...
	keys = function()
		...
		local most_used_keymaps = {
			...
			{ "<leader>/", function() Snacks.picker.grep() end, desc = "[/] search by grep", },
			...
			{ "<leader>n", function() Snacks.picker.notifications() end, desc = "search [n]otification history", },
			{ "<leader>e", function() Snacks.explorer() end, desc = "file [e]explorer", },
		}

		-- stylua: ignore
		local find_file_keymaps = {
			{ "<leader>ff", function() Snacks.picker.files() end, desc = "[f]ind [f]iles", },
			{ "<leader>fb", function() Snacks.picker.files() end, desc = "[f]ind files in [b]uffers", },
			{ "<leader>fn", function() Snacks.picker.smart({ cwd = vim.fn.stdpath("config") }) end, desc = "[f]ind in [n]eovim config", },
		...
		local search_keymaps = {
			...
			-- Grep.
			{ "<leader>sB", function() Snacks.picker.grep_buffers() end, desc = "grep [s]each open [B]uffers", },
			{ "<leader>sb", function() Snacks.picker.lines() end, desc = "[s]earch buffer lines", },
		...
		local terminal_keymaps = {
			{ "<c-_>", function() Snacks.terminal() end, desc = "[<c-_>] toggle terminal", },
		}
